...
default_preprocessing_dict = {
    ...
    'cub': {
        ...
        'pre_size': 256,       
        'img_size': 224,       
        'normalization': [[0.04336452742760852, 0.03705289004799739, 0.0425893059362092], [0.09583778722415166, 0.09293042088263824, 0.07973447107671496]],  # 这里仅作为示例，建议使用你自己数据集的均值和标准差
    }, 
}
